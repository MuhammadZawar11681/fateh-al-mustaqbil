    ...
    >
      ...
      <div className="absolute w-full bg-[rgba(184,134,11,0.6)]/80 bottom-0 py-12">
        <div className="flex items-center flex-col justify-center w-full h-full text-white md:px-20 rtl:gap-y-2">
          <h1
            className="about-text font-[gabriola] text-white opacity-1 ltr:font-[gabriola] rtl:[font-kufam] rtl:text-2xl rtl:md:text-3xl text-3xl text-center"
            data-en="Currently Operational in"
            data-ar="العاملة حاليا في"
          >
            Currently Operational in
          </h1>
          <h1
            className="about-text font-[cooper] ltr:font-cooper rtl:font-bold rtl:font-kufam rtl:text-3xl rtl:md:text-5xl text-5xl text-center"
            data-en="Saudi Arabia"
            data-ar="المملكة العربية السعودية"
          >
            Saudi Arabia
          </h1>
        </div>
